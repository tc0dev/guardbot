...
module.exports.execute = async (client, interaction, db) => {
    ...
    .setDescription(`AstraV Guard varsayılan olarak herhangi bir veri saklamaz. Sunucu Yönetme iznine sahip bir sunucu üyesi botun ön-ekini değiştirmek için önek
...
Sunucuyla ilgili başka hiçbir veri depolanmaz. BXD, kullanıcılara özel verileri asla saklamaz. Önek verileri yalnızca botun çalışması için saklanır ve
...
Ayrıca verilerin silinmesini talep etmek için [tc0dev](https://discord.com/1067432825898414130) discordumdan bana ulaşabilirsiniz veya destek sunucusuna
